...
SOUTH_HEADERS = {'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_1) '
                 ...
                 'Cookie': 'Cookie: BAIDUID=491790D52C14B044AC1720D40C4ECE0D:FG=1; '
                           'PSTM=1533540952; BIDUPSID=069429152A1027A651D60F9DF6A92037; '
                           'MCITY=-289%3A; Hm_lvt_f1ac85b7ced4769d8a20f8d77a566abc=1543285141; '
                           'UUAP_P_TOKEN_OFFLINE=PT-4926-VsII60yT6agSytWomdr9Rvcif0bfDI2xmN6-'
                           'itebeta; '
                           'Hm_lvt_e5c8f30b30415b1fc94d820ba9d4d08c=1543974828,1544062106,'
                           '1544332501,1544408722; '
                           'BDORZ=B490B5EBF6F3CD402E515D22BCDA1598; '
                           'UUAP_P_TOKEN=PT-351044-CUJdXcBnrbefCuI3VVKGd5yGN5mBJcFHodH-uuap; '
                           'express.sid=s%3ApNDCXTIsX2wbusnuuHo06dtJ777Bi7Vv.'
                           'oynyl6LGKaU8iDJtz80zE7YizxOZLBYZc'
                           'KMjAhDaQzI; '
                           'delPer=0; BDUSS=d4NkNFfkJTaUhmVElXSWZJeThwMXJKalVxOEdyZjJyeXN0N0Fh'
                           'Ykc4VXQtalpjQUFBQUFBJC'
                           'QAAAAAAAAAAAEAAADgD2smbWFya2VyX3h1AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA'
                           'AAAAAAAAAAAAAAA'
                           'AAAAAAAAAAAAAAAAAAAAAAAAC1tD1wtbQ9cdj; '
                           'BDRCVFR[feWj1Vr5u3D]=I67x6TjHwwYf0; H_PS_PSSID=27775_1446_25810_21122'
                           '_18559_28019_26350_'
                           '27751_27244_20719; PSINO=5; noah_magic_user_name=xucongbin; '
                           'USER_NOAH=xucongbin; NOAH_VERSION=0; EXPIRE_NOAH=1545129714; '
                           'SIG_NOAH=e4dadb0d60689a1f1f4ec34ab36844c2; '
                           'Hm_lpvt_e5c8f30b30415b1fc94d820ba9d4d08c=1544525746',
                 'Accept': '*/*',
...
class Qinghua(Topic):
    ...
    _pattern_post_time = r'%s[\:：][^(]+\(([^\)]+)\)[^\<]+\<br\s\/\>' % ('发信站', )
    ...
    def get_topic_list(self, board, start=None):
        ...
        <a href=bbstcon?board=WarAndPeace&file=M.1539744310.A>○ 代发，84年女征友 </a><td>
        <font color=black>4</font>/<font color=red>2602</font>
...
if __name__ == '__main__':
    ...
    for topic in org_topic_list:
        ...
        if qinghua_topic.check_topic_exists(tmp_topic_id) is True:
            ...
            qinghua_topic.update_stat(topic_id=tmp_topic_id, reply_count=topic['replyCount'],
        ...
        try:
            ...
            if len(topic_struct['body'].decode('utf8')) > 4096:
                print "topic:%s, title:%s length is large" % (tmp_topic_id, topic['topicTitle'], )
                continue
